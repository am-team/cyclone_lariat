...
module CycloneLariat
  module Generators
    module Event
      ...
      def event_v1(type, data: {}, request_id: nil, track_id: nil, group_id: nil, deduplication_id: nil, uuid: SecureRandom.uuid)
        params = {
          uuid: uuid,
          type: type,
      ...
      def event_v2(type, subject:, object:, data: {}, request_id: nil, track_id: nil, group_id: nil, deduplication_id: nil, uuid: SecureRandom.uuid)
        params = {
          uuid: uuid,
          type: type,
          subject: subject,
